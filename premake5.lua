workspace "skeletonCPP"
    startproject "skeletonCPP"
    architecture "x64"
...
project "skeletonCPP"
    ...
    filter { "system:windows", "configurations:*" }
        ...
        defines { "SKELETONCPP_PLATFORM_WINDOWS", "SFML_STATIC"}
    ...
    filter { "system:linux", "configurations:*" }
        defines { "SKELETONCPP_PLATFORM_LINUX"}
